                ...
                <div className="grid md:grid-cols-5 gap-12 items-center">
                    ...
                    <div className="md:col-span-3 text-lg text-gray-600 dark:text-gray-400 space-y-6">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 text-center my-6">
                            <div className="bg-secondary dark:bg-medium/50 p-4 rounded-lg">
                                <ExperienceIcon />
                                <h4 className="font-semibold mt-2 text-dark dark:text-white">5+ Years</h4>
                                <p className="text-sm">Experience</p>
                            </div>
                            <div className="bg-secondary dark:bg-medium/50 p-4 rounded-lg">
                                <UiUxIcon />
                                <h4 className="font-semibold mt-2 text-dark dark:text-white">Intuitive</h4>
                                <p className="text-sm">UI/UX Design</p>
                            </div>
                            <div className="bg-secondary dark:bg-medium/50 p-4 rounded-lg">
                                <ProblemSolverIcon />
                                <h4 className="font-semibold mt-2 text-dark dark:text-white">Creative</h4>
